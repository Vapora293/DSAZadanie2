...
public class Main {
    public static void main(String[] args) {
        ...
        Tester tester = new Tester(dnf, orderBuilder(4), tree);
        System.out.println("");
        for (int i = 0; i < 5; i++) {
            long start = System.currentTimeMillis();
            String dnf1 = dnfMake(13, 100);
            dnf1 = formatInput(dnf1);
            BDD tree1 = new BDD(dnf1, orderBuilder(13));
            Tester tester1 = new Tester(dnf1, orderBuilder(13), tree1);
...
//        String dnf = "ABC + !AB!C + A!BC + !ABC";
//        String dnf = "A!B!C + ABC + !ABC + !A!BC";
//        BDD tree = new BDD(dnf, orderBuilder(3));
//        dnf = formatInput(dnf);
//        Tester tester = new Tester(dnf, orderBuilder(3), tree);
